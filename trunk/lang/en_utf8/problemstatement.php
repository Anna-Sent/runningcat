<?PHP // $Id$
      // problemstatement.php - created with Moodle 1.9.2+ (2008082000)
$string['lang_0'] = 'C/C++';
$string['lang_1'] = 'Pascal/Delphi';
$string['lang_2'] = 'Java';
$string['lang_3'] = 'Python';
$string['problemstatementname'] = 'Name of problemstatement';
$string['testsdirectory'] = 'Tests directory';
$string['programwritten'] = 'Program written on ';

$string['submissioncomment'] = 'Comment';

$string['unprocessed'] = 'Waiting for processing... Refresh in some time';
$string['inprocess'] = 'Processing... Refresh in some time';
$string['success'] = 'Success!!!! :-)';
$string['unsuccess'] = 'Unsuccess!!!! :-(';
$string['compilationerror'] = 'Compilation error!!! :-|';
$string['internalerror'] = 'Internal error';
$string['timeout'] = 'You\'re out of time';
$string['memoryout'] = 'You\'re out of memory';
...
$string['modulename'] = 'Problemstatement';
$string['modulenameplural'] = 'Problemstatements';
